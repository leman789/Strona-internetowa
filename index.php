    ...
    function wysun()
        {
            x++;
            if(x==1){
                    document.getElementById("elwys1").innerHTML="<div id='elwys'><a href='ustawienia.php'>ustawienia</a><br><a href='doladuj.php'>doladuj</a><br><a href='wyloguj.php'>wyloguj</a><br></div>";
                }
            else if(x>1){
                    x=0;
